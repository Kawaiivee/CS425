...
The implementation of the project will be a web-based application using JDBC as a back-end and Node.js, HTML, CSS, and PHP as a front-end. The development environment that the project will be developed is the UNIX operating system connected through ssh with Github as a functioning repository for back-end and front-end code to updated as the project progresses. Below is a diagram for the method of implementation:
\subsection*{}
\begin{center}
