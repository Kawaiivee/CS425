...
This project consist of a web solution for an e-commerce application. The project itself will be conducted using a waterfall model\cite{waterfall} for development.  The web application will be developed using JDBC as a back-end and Node.js, html, css  as a front-end. wanghaoyu
...
%\begin{center}
%          \includegraphics[width=14cm, height=7cm]{populationbyage}
%\end{center}
\pagebreak
\section*{Design}
